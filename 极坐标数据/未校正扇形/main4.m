...
% inputIm = imread('10_22_10_35_35°.jpg'); f=1;
% inputIm = imread('10_22_10_41_37°.jpg'); f=2;
%  inputIm = imread('10_22_10_46_39°.jpg'); f=3;
inputIm = imread('10_27_00_20_32.jpg'); f=4;
...
[~, ~, label] = connect4_theta2(XDOGFilteredImage, sta_r, sta_c);
if f~=1
    figure, imshow(label)
end
...
if f~=3
    ...
    res2 = 180+atand((d2(1)-d1(1))/(d2(2)-d1(2)));
end
